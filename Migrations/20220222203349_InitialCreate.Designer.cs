...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("backend_assignment.Models.Produce", b =>
                {
            ...
            modelBuilder.Entity("backend_assignment.Models.ProduceSupplier", b =>
                {
                    b.Property<int>("ProduceID")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("backend_assignment.Models.Supplier", b =>
                {
                    b.Property<int>("SupplierID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("backend_assignment.Models.ProduceSupplier", b =>
                {
                    b.HasOne("backend_assignment.Models.Produce", "Produce")
                        .WithMany("ProduceSuppliers")
                        .HasForeignKey("ProduceID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("backend_assignment.Models.Supplier", "Supplier")
                        .WithMany("ProduceSuppliers")
